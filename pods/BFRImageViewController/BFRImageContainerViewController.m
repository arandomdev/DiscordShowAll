...
#import <PINRemoteImage/Classes/include/PINAnimatedImageView.h>
#import <PINRemoteImage/Classes/include/PINRemoteImage.h>
#import <PINRemoteImage/Classes/include/PINImageView+PINRemoteImage.h>
...
- (void)recenterImageOriginOrZoomToPoint:(UITapGestureRecognizer *)tap {
    if (self.scrollView.zoomScale == self.scrollView.maximumZoomScale) {
        ...
        CGPoint touchPoint = [tap locationInView:self.activeAssetView];
        // [self.scrollView zoomToRect:CGRectMake(touchPoint.x, touchPoint.y, 1, 1) animated:YES];

        // partially zoom in
        CGRect zoomRect;
        zoomRect.size.height = self.activeAssetView.frame.size.height / 3;
        zoomRect.size.width  = self.activeAssetView.frame.size.width  / 3;
